...
import static agroo.user.shop.activity.MainActivity.active;
import static agroo.user.shop.activity.MainActivity.bottomNavigationView;
import static agroo.user.shop.activity.MainActivity.fm;
import static agroo.user.shop.activity.MainActivity.homeClicked;
import static agroo.user.shop.activity.MainActivity.homeFragment;
