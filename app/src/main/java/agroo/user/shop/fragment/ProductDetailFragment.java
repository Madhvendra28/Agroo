package agroo.user.shop.fragment;
...
import agroo.user.shop.activity.MainActivity;
import agroo.user.shop.adapter.AdapterStyle1;
import agroo.user.shop.adapter.SliderAdapter;
...
import agroo.user.shop.helper.VolleyCallback;
import agroo.user.shop.model.Favorite;
import agroo.user.shop.model.PriceVariation;
import agroo.user.shop.model.Product;
import agroo.user.shop.model.Slider;

import static android.content.Context.INPUT_METHOD_SERVICE;
import static agroo.user.shop.helper.ApiConfig.AddOrRemoveFavorite;
import static agroo.user.shop.helper.ApiConfig.GetSettings;
