...
import agroo.user.shop.fragment.FaqFragment;
import agroo.user.shop.fragment.NotificationFragment;
import agroo.user.shop.fragment.ProfileFragment;
import agroo.user.shop.fragment.ReferEarnFragment;
import agroo.user.shop.fragment.TransactionFragment;
import agroo.user.shop.fragment.WalletTransactionFragment;
import agroo.user.shop.fragment.WebViewFragment;
import agroo.user.shop.helper.ApiConfig;
import agroo.user.shop.helper.Constant;
import agroo.user.shop.helper.Session;
import agroo.user.shop.helper.Utils;
import agroo.user.shop.ui.CircleTransform;
