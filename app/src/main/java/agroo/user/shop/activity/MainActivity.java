package agroo.user.shop.activity;
...
import agroo.user.shop.R;
import agroo.user.shop.fragment.AddressListFragment;
import agroo.user.shop.fragment.CartFragment;
import agroo.user.shop.fragment.CategoryFragment;
import agroo.user.shop.fragment.FavoriteFragment;
import agroo.user.shop.fragment.HomeFragment;
import agroo.user.shop.fragment.OrderPlacedFragment;
import agroo.user.shop.fragment.PaymentFragment;
import agroo.user.shop.fragment.ProductDetailFragment;
import agroo.user.shop.fragment.SearchFragment;
import agroo.user.shop.fragment.SubCategoryFragment;
import agroo.user.shop.fragment.TrackOrderFragment;
import agroo.user.shop.fragment.TrackerDetailFragment;
import agroo.user.shop.fragment.WalletTransactionFragment;
import agroo.user.shop.helper.ApiConfig;
import agroo.user.shop.helper.Constant;
import agroo.user.shop.helper.DatabaseHelper;
import agroo.user.shop.helper.Session;
...
//        setAppLocal("en"); //Change you language code here
    ...
    private void startSupportChat() {
        try {
            ...
            String trimToNumner = "+91 7871707007"; //10 digit number
